(function () {
    ...
    /** @ngInject */
    function PendingDebitModalCtrl($uibModalInstance,$scope,$http,environmentConfig,cookieManagement,toastr,transaction,errorToasts,errorHandler,metadataTextService,$location) {
